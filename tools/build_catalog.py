...
add('clean-house','Clean House','sim','Choose a house, clear rubbish and scrub surfaces to increase its value. Switch Look mode on to turn the camera; use + / − to zoom.','CleanHouse/index.html','clean-house.webp',tags=('cleaning','3d','satisfying'),frm='Cabinet')
...
add('chili-firm','Chili Firm 2: Replanted','idle','Grandma Rosa left you twelve pots and a rusty hose. Team up with hot-sauce rapper Tito Scorch, grow chillies under the grow lights from sprout to ripe, flip them to walk-in buyers, hire a crew and build Scorch Farms into a hot-sauce empire.','ChiliFirm/index.html','chili-firm.webp',tags=('idle','farm','tycoon','story'),new=True,featured=True,frm='Cabinet',note='Tap a pot to plant, tap again to water and harvest, or swipe across a row. The big button always does the next useful thing.')
...
GODOT_NOTE='First launch downloads a shared 38 MB player plus this game. Landscape is recommended on phones. Loading speed and graphics support depend on your device.'
GD = [
