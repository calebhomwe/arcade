...
GD = [
 ('godot-claire-big-life',"Caleb's Farm",'sim',"Grow golden wheat, sunflowers and strawberries, feed chickens, cows and sheep, bake in your own bakery, fill delivery orders and build out the village. Music library and graphics options in Settings.",'claire-big-life',('farm','life sim','kids','township'),True,'WASD or arrows to walk, E to interact, tap or click anything that glows.'),
